package com.omarbradley.oemssample.movie.web;
...
import com.omarbradley.oemssample.movie.ibsheetjson.MovieIbSheetJson;
...
public class MovieController {
	...
	@Resource(name = "movieIbSheetJson")
	private MovieIbSheetJson movieIbSheetJson;
	...
	public ModelAndView getAllMovies() {
		...
		modelAndView.addObject("initData", movieIbSheetJson.createAllMovieSheetJson());
		modelAndView.addObject("data", jsonParserUtil.convertJson(movieService.getAllMovies()));
		return modelAndView;
	}
